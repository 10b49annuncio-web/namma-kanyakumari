  ...
  Future<void> login() async {
    ...
    try {
      ...
      if (currentUser != null && currentUser.emailVerified) {
        // Firebase Auth already knows this user is verified, but
        // Firestore only gets updated when the verification screen's
        // check runs. If someone verifies their email and then logs
        // in directly (skipping that screen), Firestore would stay
        // stale forever without this.
        ...
        // Pull the profile doc and cache the session locally so the
        // rest of the app doesn't need to hit Firestore just to know
        // who's logged in.
